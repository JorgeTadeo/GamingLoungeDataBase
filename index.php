...
<html>
  ...
  <body>
	...
	<main>
		<div class="sitewidth bottom">
			<div class="boxsize">
				<div class="div1 py justify-center flex text-center color">
		...
		<div class="container-fluid sitewidth no-padding bottom">
		  <div class="row no-gutters">
			<div class="col-lg">
			  	<div class=" justify-center flex items-center color ">
					<img class="block" src="holding-coffee.jpg">
				</div>
			</div>
			<div class="col-lg color justify-center text-center flex items-center">
			  	<div class="py div1">
					<div class="block">
						<h1 class="sb-heading font1 mb4" tabindex="-1">
							<span class="width box-sizing">Our Pledge to our customers</span>
						</h1>
						<div class="font width">
							Here at the cafe we value good customer service and a great attitude. Always providing the best customer service since 2012.
						</div>						
					</div>
				</div>
			</div>
		 ...
		 <div class="container-fluid sitewidth no-padding bottom">
		  <div class="row no-gutters">
			<div class="col-lg color justify-center text-center flex items-center color">
			  	<div class="py div1">
					<div class="block">
						<h1 class="sb-heading font1 mb4" tabindex="-1">
							<span class="width box-sizing">Serving Fresh Coffee</span>
						</h1>
						<div class="font width">
							All of our in house coffee is grinded and made fresh on each and everyday. 
						</div>						
					</div>
				</div>
			</div>
			<div class="col-lg">
			  	<div class=" justify-center flex items-center color order-first order-md-last">
					<img class="block" src="coffee.jpg">
				</div>
			</div>
		  </div>
		 </div>
		  ...
		  <div class="row no-gutters">
			...
			<div class="col-lg color justify-center text-center flex items-center">
			  	<div class="py div1">
					<div class="block">
						<h1 class="sb-heading font1 mb4" tabindex="-1">
							<span class="width box-sizing">Download our App</span>
						</h1>
						<div class="font width">
							With the new Cafe Db app ordering coffee has never been easier!
						</div>						
					</div>
				</div>
			</div>
